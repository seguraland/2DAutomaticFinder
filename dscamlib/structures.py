...
class CAM_FeatureNameRef(ctypes.Structure):
    _fields_ = [
        ("eId", ctypes.c_uint32),  # Assuming ECamFeatureId values are stored as integers
...
class CAM_Format(ctypes.Structure):
    _fields_ = [
        ("eColor", ctypes.c_uint),  # Assuming ECamFormatColor is an enum
        ("eMode", ctypes.c_uint),  # Assuming ECamFormatMode is an enum
    ]
...
class CAM_Variant(ctypes.Structure):
    _fields_ = [
        ("eVarType", ECamVariantRunType),  # Assuming ECamVariantRunType is an enum
...
class CAM_FeatureDesc(ctypes.Structure):
    _fields_ = [
        ...
        ("eFeatureDescType", ECamFeatureDescType),
...
class CAM_EventFeatureChanged(ctypes.Structure):
    _fields_ = [
        ...
        ("uiTick64", ctypes.c_uint64),
        ("uiFeatureId", ctypes.c_uint32),
        ("stVariant", CAM_Variant)  # Assuming CAM_Variant is a separate structure
    ]
...
class CAM_EventBusReset(ctypes.Structure):
    _fields_ = [
        ("uiTick", ctypes.c_uint32),
        ("uiTick64", ctypes.c_uint64),
        ("eBusResetCode", ECamEventBusResetCode),  # Assuming ECamEventBusResetCode is an enum or a type
...
class CAM_Notice(ctypes.Structure):
    ...
    _fields_ = [
        ("eNoticeType", ECamNoticeType),  # Assuming ECamNoticeType is an enum or a type
